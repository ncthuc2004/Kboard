...
![License](https://img.shields.io/badge/Version-v1.1.0-FF6D00?style=for-the-badge)
...
[Tác giả: Kaius (Nguyễn Công Thức)](https://github.com/ncthuc2004) • [Tải APK v1.1.0](file:///t:/Kaius_Inc/K_Keyboard/Kaius_Keyboard.apk) • [Windows Receiver](file:///t:/Kaius_Inc/K_Keyboard/Kaius_Receiver.exe)
...
### 1. 🎮 Layout chuẩn 75% PC Mechanical Keyboard
...
### 2. 📡 Công nghệ truyền tải kép (Dual-Transport)
...
### 3. 🇻🇳 Bộ gõ Tiếng Việt Telex & Bàn phím ảo hệ thống (Android IME)
...
* **Vietnamese Telex Engine nguyên bản**:
  ...
  * Công tắc chuyển nhanh `[ 🇻🇳 Tiếng Việt: BẬT ]` / `[ 🇺🇸 English ]` ngay trên thanh trạng thái IME.

### 4. 💻 Windows Companion Receiver (`Kaius_Receiver.exe`)
...
### 📦 1. Tải về & Cài đặt
* **File APK mới nhất:** Tải file [`Kaius_Keyboard.apk`](file:///t:/Kaius_Inc/K_Keyboard/Kaius_Keyboard.apk) và cài đặt lên điện thoại.
...
1. Trên điện thoại làm bàn phím: Chọn tab `[ 🔵 Bluetooth HID ]` -> Bấm biểu tượng kính lúp để bật chế độ sẵn sàng kết nối (`Discoverable`).
...
* **Kỹ sư phát triển:** **Kaius (Nguyễn Công Thức)**
